/**
 ...
 @apiDescription
 Получить сохраненного пассажира  из личного кабинета
 в ответ вернется созданный пассажир, созданные для него
 документы и т.д. это можно использовать для автозаполнения
 полей ввода (пассажир единожды в личном кабинете сохраняет информацию)
 потом может в один клик заполнить все поля
